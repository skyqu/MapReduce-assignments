...
public class TextSpammingIMC extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(TextSpammingIMC.class);
    ...
    public void map(PairOfStrings key, PairOfIntString value, Context context) throws IOException,
      ...
      for (String2IntOpenHashMapWritable.Entry<String> e : MAP.object2IntEntrySet()) {
        ...
        //context.write(BIGRAM, TF);
   	  	if(!ht.containsKey(bigram)&&bigram.length()!=0)  
   	  	{
		  ht.put(bigram, 1);
   	  	}
   	  	else if(bigram.length()!=0){
		  ht.put(bigram,(Integer)ht.get(bigram)+1);
  ...
  private static class MyReducer4 extends
    ...
    public void reduce(Text key, Iterable<String2FloatOpenHashMapWritable> values, Context context)
      ...
      float averageSimilarityTimesCount = 2 * cosineSimilarity / (tfidfVectorList.size() -counteri- 1);
  ...
  public int run(String[] args) throws Exception {
   ...
   /* if (!cmdline.hasOption(INPUT) || !cmdline.hasOption(OUTPUT)) {
    ...
    String outputPath = "xzzqskfinal/TSScoreIMC"; // cmdline.getOptionValue(OUTPUT);
    //String inputPath = cmdline.getOptionValue(INPUT);
    //String outputPath = cmdline.getOptionValue(OUTPUT);
    int reduceTasks = cmdline.hasOption(NUM_REDUCERS) ? Integer.parseInt(cmdline
        .getOptionValue(NUM_REDUCERS)) : 1;

    LOG.info("Tool: " + TextSpammingIMC.class.getSimpleName());
    ...
    job1.setJobName(TextSpammingIMC.class.getSimpleName());
    job1.setJarByClass(TextSpammingIMC.class);
...
//    job1.setOutputFormatClass(TextOutputFormat.class);
    ...
    job2.setJobName(TextSpammingIMC.class.getSimpleName());
    job2.setJarByClass(TextSpammingIMC.class);
    ...
    job3.setJobName(TextSpammingIMC.class.getSimpleName());
    job3.setJarByClass(TextSpammingIMC.class);
    ...
    job4.setJobName(TextSpammingIMC.class.getSimpleName());
    job4.setJarByClass(TextSpammingIMC.class);
    ...
    job5.setJobName(TextSpammingIMC.class.getSimpleName());
    job5.setJarByClass(TextSpammingIMC.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new TextSpammingIMC(), args);
  }
}