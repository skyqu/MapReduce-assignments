 ...
 */
public class PairOfWritablesM<L extends Writable, R extends Writable> implements Writable {

	private L leftElement;
	private R rightElement;

	/**
	 * Creates a new <code>PairOfWritablesM</code>.
	 */
	public PairOfWritablesM() {}

	/**
	 * Creates a new <code>PairOfWritablesM</code>.
	 */
	public PairOfWritablesM(L left, R right) {
		leftElement = left;
		rightElement = right;
	}
	...
	public void readFields(DataInput in) throws IOException {
		...
		try {
			...
			throw new RuntimeException("Unable to create PairOfWritablesM!");
		}
	}
	...
	public PairOfWritablesM<L,R> clone() {
		return new PairOfWritablesM<L,R>(this.leftElement, this.rightElement);
	}
	...
	public void setcp(PairOfWritablesM<L,R> PAIR) {
